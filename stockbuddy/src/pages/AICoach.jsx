...
function AICoach() {
  ...
  // Use the chat hook - but manage it carefully to handle bounce scenario logic
  const chatHook = useCoachChat(scenario, true);
  const { addMessage, resetChat, setChatMessages, chatMessages } = chatHook;
